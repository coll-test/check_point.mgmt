...
import pytest
from ansible_collections.check_point.mgmt.tests.unit.modules.utils import set_module_args, exit_json, fail_json, AnsibleExitJson

from ansible.module_utils import basic
from ansible_collections.check_point.mgmt.plugins.modules import cp_mgmt_application_site_group
...
function_path = 'ansible_collections.check_point.mgmt.plugins.modules.cp_mgmt_application_site_group.api_call'
...
class TestCheckpointApplicationSiteGroup(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.check_point.mgmt.plugins.module_utils.network.checkpoint.checkpoint.Connection')
